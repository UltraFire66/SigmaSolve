            ...
            <View style={[styles.view1, {justifyContent: 'center', backgroundColor: "blue", width:"100%"}]}>
              <LinearGradient style={[styles.view1, {width:'100%', alignItems: 'center', justifyContent:'center'}]} colors={['#00AACC', '#0066FF']}>
                  <View style={{backgroundColor: '#D9D9D9', height: vh(80), width: vw(85), borderRadius: 40}}>
                    ...
                    <TouchableOpacity style={{marginBottom:0, marginTop:"15%", marginLeft:"10%", height:"8%", width:'80%', alignItems: 'center', justifyContent:'center', borderRadius:10}} onPress={() => {handleSelect()} }>
                    ...
                    <TouchableOpacity style={{marginTop:"5%", marginLeft:"10%", height:"8%",width:'80%', borderColor:"#0066FF", borderWidth:1, alignItems: 'center', justifyContent:'center', borderRadius:10}} onPress={() => navigation.navigate('Cadastro')}> 
                          <Text style={{color:'#0066FF', fontSize: 22}}>Criar Conta</Text>
                    </TouchableOpacity> 
                  </View>
              </LinearGradient>
            </View>
